...
export type colorKeyframe = [BaseColor, [number, number, number, number, colorModifier], number, easingType?] |
                            [BaseColor, number, easingType?] |
                            [number, number, number, number, number, easingType?];
...
export type colorAnim = colorKeyframe[] | vec4 | [BaseColor, [number, number, number, number, colorModifier]] | BaseColor | string;
