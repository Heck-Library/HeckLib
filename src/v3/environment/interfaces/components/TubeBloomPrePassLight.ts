import { IEnvironmentComponent } from "./IEnvironmentComponent";

export class TubeBloomPrePassLight implements IEnvironmentComponent {
    ...
    ConvertToComponent(): Record<string, number> {
        return {
            colorAlphaMultiplier: this.colorAlphaMultiplier,
            bloomFogIntensityMultiplier: this.bloomFogIntensityMultiplier
        };
    }
}